...
<div class="container" ng-app="myApp" ng-controller="productsCtrl">
	<div class="row">
		<div class="col s12">
			...
			<div id="modal-product-form" class="modal" ng-show="showForm">
			...
			<!--overlay-->
			<div class="lean-overlay" ng-show="showForm"></div>
			<!--/overlay-->
	...
	$scope.processForm = function(){
		...
		$('#btn-create-product').click(function(){
			//fields in key-value pairs
			 ...
			 $http.post('create_product.php', $scope.product).then(function(response){
				 console.log(response.data);
				 //tell the user new product was created
				 Materialize.toast(response.data, 4000);
